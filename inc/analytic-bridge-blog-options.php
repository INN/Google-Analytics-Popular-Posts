...
function analyticbridge_blog_options_admin_head() {
	...
	gapi.analytics.ready(function() {
		...
		jQuery('input[name=analyticbridge_setting_account_profile_id]')
			.before(jQuery('<div id="google-view-selector"></div>'));
...
function analyticbridge_option_page_html() {
	...
	if ( analyticbridge_client_id() && analyticbridge_client_secret() ) {
		...
		} else if ( ! get_option( 'analyticbridge_access_token' ) ) {
